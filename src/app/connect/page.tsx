...
function ConnectPageContainer() {
    ...
    return (
        <div className="space-y-8">
            <MainHeader title="Connect" description="Schedule a private room and invite others for a real-time, multi-language voice conversation." />
            <SyncOnlineHome />
        </div>
    );
}
