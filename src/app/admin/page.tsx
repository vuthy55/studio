...
function UsersTabContent2() {
    ...
    useEffect(() => {
        ...
        fetchUsers2(debouncedSearchTerm);
    }, [debouncedSearchTerm, fetchUsers2]);
        ...
        <div className="space-y-8">
            ...
            <Tabs defaultValue="users" className="w-full">
                <TabsList className="grid w-full grid-cols-5">
                    ...
                    <TabsTrigger value="users2">Users 2</TabsTrigger>
                ...
                <TabsContent value="users2" className="mt-6">
                    <UsersTabContent2 />
                </TabsContent>
