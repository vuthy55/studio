...
export default function OfflineManager() {
  const { userProfile, settings, offlineAudioPacks, loadSingleOfflinePack, removeOfflinePack, savedPhrases, resyncSavedPhrasesAudio, unlockLanguagePack, isCacheLoading } = useUserData();
  ...
  }, [offlineAudioPacks, savedPhrases.length, userProfile?.downloadedPacks, isCacheLoading]);
