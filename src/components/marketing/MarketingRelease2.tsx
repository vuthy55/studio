  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto p-4 prose prose-sm prose-headings:font-bold prose-headings:text-primary prose-a:text-primary hover:prose-a:text-primary/80 prose-strong:text-foreground">
      ...
      <section>
        ...
        <p>
          At the temples, Alex met a group of fellow travelers—Aisha from Malaysia, Zoya from Egypt, and Linh from Vietnam. They were all trying to communicate with a mix of gestures and broken English. Seeing the struggle, Alex pulled out their phone and opened <strong>Sync Live</strong>.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          The group became inseparable for the rest of their time in Siem Reap. When they eventually had to part ways, they promised to keep in touch. This is where <strong>Sync Online</strong> became their lifeline.
        </p>
        <p>
