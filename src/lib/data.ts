...
export const offlineAudioPackLanguages: LanguageCode[] = ['khmer', 'chinese', 'english', 'burmese', 'filipino', 'french', 'indonesian', 'italian', 'laos', 'malay', 'spanish', 'tamil', 'thai', 'vietnamese'];
