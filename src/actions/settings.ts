...
const AppSettingsSchema = z.object({
  ...
  freeSavedPhrasesLimit: z.number().default(100),
  ...
  summaryGenerationCost: z.number().default(50).describe('Token cost for the host to generate the initial summary and transcript.'),
  maxSummaryEdits: z.number().default(2).describe('How many times a host can edit a generated summary.'),
